...
namespace NList
{
    ...
    public class List
    {
        ...
        virtual public void AddElementToPosition(int value, Position pos)
        {
            if (head == null)
            {
                head = new ListElement(value, null);
        ...
        virtual public void DeleteElement(int deleteNum)
        {
            if (head == null)
            {
        ...
        public Position PositionElement(int value)
        {
            ListElement temp = head;
            int i = 0;
